...
const HospitalList = () => {
  ...
  const handleGetlist = async (value) => {
    setLoading(true);
    const result = await HospitalService.getListHospital(params);
              ...
              <Row>
                <Col sm="4" className="mb-2">
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input placeholder="Tên bệnh viện" {...field} />
                    )}
                  />
                </Col>
                <Col sm="4">
            ...
            <Row className="mx-0 my-1 align-items-center d-lg-flex d-none d-md-flex">
              <Col md="3" className="mb-2">
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input {...field} placeholder="Tên bệnh viện" />
                  )}
                />
              </Col>
              <Col md="3" className="mb-2">
