...
import Columns from "./columns-department";
...
const DepartmentList = () => {
  ...
  const handleGetlist = async (value) => {
    setLoading(true);
    const result = await DepartmentService.getListDepartment(params);
              ...
              <Row>
                ...
                <Col md="4">
                  ...
                  <Row className="mt-2">
                    ...
                    {isAuthCreate && (
                      <Link to="/apps/department/add">
                        <Button color="dark" outline tag={Label} size="md">
                          <span className="align-middle ms-25">Tạo phòng ban</span>
                        </Button>
                      </Link>
                    )}                  
                  </Row>
