      ...
      >
        ...
        >
          ...
          >
            <Select
              ...
              onSelect={(value: number) => {
                ...
                form.setFieldsValue({
                  "city_id":null,
                  "city_id_view": "", "country_id_view": value
                });
                // if (val == 0) {
          ...
          <Form.Item
            ...
            name={"country_id_view"}
            label={translation("countryID")}>
            <input disabled className="c2i-input mt-2.5 capitalize" />
